...
WITH "EndedWarPerformances" AS (SELECT Cwpp.*,
     ...
     "AttackMetrics" AS (SELECT "PlayerTag",
                                ...
                                AVG("Stars")::real                                                        AS "AvgStarsPerAttack",
     ...
     "PlayerWarStats" AS (SELECT "PlayerTag",
                                 "StartTime",
                                 "MapPosition",
                                 "TownHallLevel",
     ...
     "WarMetrics" AS (SELECT "PlayerTag",
...
SELECT Cm."Tag"                                                AS "Tag",
       ...
       COALESCE(Am."AvgStarsPerAttack", 0)                     AS "AverageStarsPerAttack",
